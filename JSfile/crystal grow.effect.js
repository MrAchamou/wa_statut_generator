...
export const crystal growEffect = {
  id: "crystal grow",
  name: "Crystal grow",
  
  description: `## 💎 EFFET 23 : CRYSTAL GROW

**CATÉGORIE :** TEXT  
**EFFET DEMANDÉ :** Crystal_Grow  
**ID UNIQUE :** crystalline-formation-023  
**NOM AFFICHAGE :** Cristallogenèse Progressive  

**DESCRIPTION :** Croissance cristalline progressive avec structures géométriques complexes. Nucléation à partir de points germes, croissance fractale selon les lois cristallographiques, facettes qui réfléchissent la lumière. Couleurs prismatiques avec dispersion spectrale réaliste.

**SPÉCIFICATIONS ADDICTION :**
- Croissance fractale imprévisible mais géométrique
- Facettes cristallines avec réflexions prismatiques
- Points de nucléation qui créent des patterns complexes
- Dispersion spectrale créant des arc-en-ciel internes

---------------------------------------------------------------

💎 CRYSTAL GROW - CRISTALLOGENÈSE PROGRESSIVE CRÉÉE !
J'ai développé l'effet "Cristallogenèse Progressive" avec une croissance fractale complexe et ultra-addictive :
🧬 SYSTÈME DE CRISTALLOGENÈSE RÉALISTE :
⚛️ NUCLÉATION CONTRÔLÉE :

Points germes avec énergies variables
Activation temporelle échelonnée
4 géométries cristallines (hexagonal, cubic, orthorhombic, tetragonal)
Pattern de croissance selon les lois cristallographiques

🌿 CROISSANCE FRACTALE :

Expansion selon vectors de croissance géométriques
Génération de cristaux enfants (2 générations)
Conservation des propriétés cristallines héritées
Croissance organique avec variations aléatoirement contrôlées

🌈 OPTIQUE AVANCÉE ET DISPERSION :
💡 SYSTÈME DE RÉFRACTION :

8 couleurs spectrales avec indices de réfraction distincts
Calcul d'angles de dispersion réalistes
Intensités variables selon l'orientation des facettes

✨ FACETTES RÉFLÉCHISSANTES :

Génération dynamique des faces cristallines
Calcul des normales pour éclairage correct
Réflectance basée sur l'angle avec 3 sources lumineuses
Pool de 500 facettes pour optimisation

🔮 DISPERSION PRISMATIQUE :

Arc-en-ciel internes avec rayons dispersés
Couleurs qui dansent selon l'angle de vue
Effets de brillance et reflets stellaires

🎭 CYCLE DE CROISSANCE ADDICTIF :
📈 5 PHASES DISTINCTES :

Nucléation : Activation mystérieuse des points germes
Croissance : Expansion fractale hypnotique
Facetting : Apparition des surfaces réfléchissantes
Dispersion : Explosion de couleurs prismatiques
Reformation : Dissolution et renaissance cyclique

🎨 DÉTAILS PROGRESSIFS :

Révélation graduelle de la complexité géométrique
Micro-animations sur chaque cristal individuel
Patterns émergents imprévisibles mais cohérents

⚡ OPTIMISATIONS AVANCÉES :

Object pooling : 150 cristaux + 500 facettes réutilisés
Calculs géométriques précalculés pour chaque type
Rendu conditionnel selon l'état de croissance
Nettoyage automatique des éléments inactifs

🎛️ PARAMÈTRES CONFIGURABLES :

Vitesse : Speed de croissance et transitions
Intensité : Taille maximale des cristaux
Complexité : Nombre de points de nucléation
Dispersion : Intensité des effets prismatiques
Couleur Base : Teinte cristalline principale
Brillance : Intensité des reflets et réflexions

L'effet simule une véritable cristallogenèse avec physique optique réaliste et croissance fractale fascinante ! 🚀💎`,
  ...
  tags: ["text", "phase", "prism", "explosion", "crystal grow"],
