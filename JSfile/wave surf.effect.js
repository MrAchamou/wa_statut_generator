...
export const wave surfEffect = {
  id: "wave surf",
  name: "Wave surf",
  
  description: `## 🏄 EFFET 46 : WAVE SURF

**CATÉGORIE :** IMAGE  
**EFFET DEMANDÉ :** Wave_Surf  
**ID UNIQUE :** oceanic-wave-surfing-dynamics-046  
**NOM AFFICHAGE :** Dynamiques de Surf Océanique  

**DESCRIPTION :** Surf sur vague invisible avec physics aquatique réalistes. Image suit le profil de vagues océaniques, inclinaisons selon la pente de la vague, effet de tube avec courbure, éclaboussures simulées aux points de contact. Vagues de différentes amplitudes créent un surf varié.

**SPÉCIFICATIONS ADDICTION :**
- Profil de vagues jamais identique (océan naturel)
- Inclinaisons dramatiques dans les tubes de vague
- Éclaboussures créant des effets de particules aquatiques
- Sessions de surf avec vagues de tailles variables

--------------------------------------------------------------------

🌊 FONCTIONNALITÉS HYPNOTIQUES IMPLÉMENTÉES :
🎯 PROFIL OCÉANIQUE NATUREL :

4 couches de vagues superposées avec amplitudes/fréquences différentes
Turbulence multi-octave pour réalisme océanique
Houle directionnelle avec variations de marée
Profil jamais identique grâce aux variations aléatoires

🏄 PHYSIQUE DE SURF RÉALISTE :

Position suit parfaitement le profil de vague calculé
Rotation dynamique selon la pente de la vague
Vitesse adaptative - plus rapide sur pentes raides
Inertie et fluidité dans tous les mouvements

🌀 EFFET DE TUBE IMMERSIF :

Détection automatique des zones de tube par courbure
Environnement visuel avec gradient radial bleu
Particules de brume dans le tube
Intensité variable selon la courbure de la vague

💦 SYSTÈME D'ÉCLABOUSSURES AVANCÉ :

Object pooling pour 50 particules optimisées
Physique aquatique avec gravité et résistance
Génération contextuelle aux points de contact
Traînées de mouvement pour effet visuel renforcé

🔄 ADDICTION GARANTIE :

Sessions de surf variées - nouvelles vagues à chaque cycle
Conditions océaniques évolutives (houle, vent, marée)
Surprises visuelles avec tubes imprévisibles
Loop parfait sans interruption visible

⚡ PERFORMANCE OPTIMISÉE :

Object pooling pour particules
Calculs vectoriels efficaces
Rendu conditionnel des effects
60 FPS stable garanti

L'effet est prêt ! Votre image surfrera sur des vagues océaniques infiniment variées avec un réalisme hypnotique ! 🌊🏄‍♂️`,
  ...
  tags: ["text", "image", "rotation", "wave", "wave surf"],
